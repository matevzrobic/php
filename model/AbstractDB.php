...
abstract class AbstractDB {
    ...
    public static abstract function getSpecificBooks(array $id);

    public static abstract function getUsers();

    public static abstract function addUser(array $params);

    public static abstract function updateUser(array $params);

    public static abstract function createOrder(array $params);

    public static abstract function createOrderItem(array $params);

    public static abstract function createAdress(array $params);

    public static abstract function updateAdress(array $params);

    public static abstract function getAdress(array $params);

    public static abstract function getOrders();

    public static abstract function modifyOrders(array $params);

    public static abstract function getOrderDetails(array $params);

    public static abstract function deleteBook(array $params);

    public static abstract function deleteCostumer(array $params);
}
